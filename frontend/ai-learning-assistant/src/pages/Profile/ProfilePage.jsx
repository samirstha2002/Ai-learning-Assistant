...
function ProfilePage() {
  ...
  const handleChangePassword = async (e) => {
    ...
    if (newPassword.length < 6) {
      toast.error("New password must bea at least 6 characters long");
      return;
    }
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <p className="w-full h-9 pl-9 pr-3 pt-2 border border-neutral-200 rounded-lg bg0neutral-50 text-sm text-neutral-900  ">
                  {username}
                </p>
              </div>
            </div>
