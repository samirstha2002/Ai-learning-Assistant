import { Clock, Trash2, BookOpen, FileText, BrainCircuit } from "lucide-react";
...
function DocumentCard({ document, onDelete }) {
  ...
  return (
    <div
      className="group relative bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shaow-xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1"
