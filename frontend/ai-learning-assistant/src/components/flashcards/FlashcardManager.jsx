...
function FlashcardManager({ documentId }) {
      ...
      return (
        <div className="flex flex-col items-center justify-center py-16 px-6">
          ...
          <button
            ...
            disabled={generating}
            className="group inline-flex items-center gap-2 px-6 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active-scale-100"
          >
            {generating ? (
              <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {flashcardSets.map((set) => (
            <div
              ...
              className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl p-6 hover:border-emerald-300 hover:shaow-lg hover:shadow-emerald-500/10 transition-all duration-200  cursor-pointer "
            >
              {/* Delete */}
              <button
  ...
  return (
    <>
      <div className="b-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-8 ">
        {selectedSet ? renderFlashcardsViewer() : renderSetList()}
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex  items-center justify-end gap-3 pt-2">
            <button
              ...
              disabled={deleting}
              className="flex-1 h-11 px-5 border-2 t border-slate-200 rounded-xl bg-slate-100 text-slate-700 text-sm font-medium hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            <button
