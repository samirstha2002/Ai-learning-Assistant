  ...
  return (
    <>
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
        {/* Header */}
        <div className="px-6 py-5 border-b border-slate-200/60 bg-linear-to-br from-slate-50/50 tp-white/50 ">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2 ">
                  <div className="w-8 h-8 rounded-lg bg-linea-to-br from-blue-100 to-cyan-100 flex items-center justify-center">
                    <BookOpen
          ...
          <div className="group p-5 bg-linear-to-br from-slate-50/50  to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200 ">
            <form onSubmit={handleExplainConcept}>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 rounded-lg bg-linear-to-r from-amber-100 to-orange-100 flex items-center justifys-center">
                  <Lightbulb
              ...
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
                Enter a topic concept from the document to get a detailed
                explanation
              </p>
              <div className="flex items-center gap-3">
                <input
                ...
                <button
                  ...
                  className="shrink-0 h-11 px-5 bg-linear-to-r from-emerald-600 to-emerald-500 hover:form-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold  rounded-xl transition-all duration-200  shadow-lg  shadow-purple-500/25 disabled:opacity-50  disabled:cursor-not-allowed active:scale-95   "
                >
