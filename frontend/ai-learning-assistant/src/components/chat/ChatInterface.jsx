...
function ChatInterface() {
  ...
  const renderMessage = (msg, index) => {
    ...
    return (
      ...
      >
        {!isUser && (
          <div className="w-9 h-9 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 flex items-center justify-center shrink-0  ">
        ...
        >
          {isUser ? (
            ...
            <div className="prose prose-sm max-w-none prose-state">
